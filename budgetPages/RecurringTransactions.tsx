...
const RecurringTransactions = ({transactionsPageVisible, setTransactionsPageVisible, transactions}) => {
console.log(transactions)
  ...
  >
    ...
    <FlatList
      ...
      />
        <Button title="backToBudget" onPress={()=>{setTransactionsPageVisible(false)}}/>
      </View>
 </Modal>
  )
}
