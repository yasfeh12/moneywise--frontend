...
const Essential = ({essentialPageVisible, setEssentialPageVisible, essentialTransactions}) => {
  return (
    <Modal
    animationType="slide"
    transparent={false}
    visible={essentialPageVisible}
    // onRequestClose={() => setEssentialPageVisible(false)}
  >
    <View>
    <FlatList
        data={essentialTransactions}
      ...
      />
        <Button title="backToBudget" onPress={()=>{setEssentialPageVisible(false)}}/>
      </View>
 </Modal>
  )
}
